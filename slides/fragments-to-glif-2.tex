...
> \textbf{my-translate} {\small\color{nlfont}"Every student paints and is quiet."}\\
{\color{logicfont}$\forall x.s(x)\Rightarrow(p(x)\wedge q(x))$}\\[1.5em]
> \textbf{my-answer} {\small\color{nlfont}"Every student is quiet. John is a student. Is John quiet?"}\\
