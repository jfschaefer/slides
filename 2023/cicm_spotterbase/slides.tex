...
\title{Towards an Annotation Standard for STEM Documents \\\large Datasets, Benchmarks, and Spotters}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        \node (frag) at (0, 0) {\begin{tabular}l\examplecite{johst2013multicolor}\\\includegraphics[scale=0.3]{declwithocc.png}\end{tabular}};
        \pause
