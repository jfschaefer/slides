...
\addbibresource{../cicm_spotterbase/bib.bib}
\addbibresource{../cicm_spotterbase/examples.bib}
...
\input{../cicm_spotterbase/intro.tex}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item supports a wide range of annotation types
            \com{ABoSpec files for new types of declarations}
